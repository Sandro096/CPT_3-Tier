...
| File | Description |
|---|---|
| `NetworkLabReport_Final.docx` | Full lab report with all configurations, IP tables, and test results |
| `README.md` | This file |

> The `.pkt` Packet Tracer file can be added to reproduce the lab from scratch.
...
For full device configurations, IP addressing tables, DHCP pools, ACL rules, and test results, refer to the attached **[NetworkLabReport_Final.docx](./NetworkLabReport_Final.docx)**.
